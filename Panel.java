...
public class Panel extends JPanel {
    ...
    public JPanel constructPanel(){
        ...
        pan.add(lb1);
        lb2 = new JLabel("Path receive c");
        lb2.setBounds(100, 130, 100, 40);
        pan.add(lb2);
        lb3 = new JLabel("Path receive c1");
        lb3.setBounds(100, 190, 100, 40);
        pan.add(lb3);
        ...
        text3.setBounds(200, 200, 170, 30);
        pan.add(text3);

        send = new JButton("Send");
        send.setBounds(230, 250, 100,30);
